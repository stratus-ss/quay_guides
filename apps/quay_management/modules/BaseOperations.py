...
class BaseOperations:
    def __init__(self, config_file, args: dict = None):
        ...
        all_options = {
                        ...
                        "init_token": {"type": "string", "desc": "The token that is generated by the setup process of this script. It is the hidden token for the initial user"},
        ...
        if args:                
            ...
            try:
                ...
                if args.add_admin_org:
                    ...
                    for key in sync_generic_options:
                        # Only want the destination related variables from the config.yaml
            ...
            try:
                ...
                pass
            try:
                args.destination_quay_install
                if args.destination_quay_install:
                    add_these_options = all_options.copy()
                    remove_these = ["init_token", "robot_config", "repositories", "proxycache", "initialize_username", "initialize_password", "initialize_email"]
                    for item in remove_these:
                        add_these_options.pop(item, None)
                    expected_config_values = build_dict(add_these_options=add_these_options, incoming_dict=expected_config_values)
            except:
                pass
            try:
                ...
                if args.initialize_user:
                    ...
                    new_items = [{"initialize_username": all_options["initialize_username"]},
                                ...
                                {"init_token": all_options["init_token"]},
                    ]
